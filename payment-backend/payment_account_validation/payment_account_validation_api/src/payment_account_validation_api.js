...
/**
 * 
 * @class payment_account_validation_api
 * @param {(string|object)} [domainOrOptions] - The project domain or options object. If object, see the object's optional properties.
 * @param {string} [domainOrOptions.domain] - The project domain
 * @param {object} [domainOrOptions.token] - auth token - object with value property and optional headerOrQueryName and isQuery properties
 */
var payment_account_validation_api = (function() {
    'use strict';
    ...
    function payment_account_validation_api(options) {
     ...
     * @method
     * @name payment_account_validation_api#cardvalidation
     * @param {string} xClientTransactionId - 
     * @param {} cardvalidationPOSTPayload - Resource body for Card Validation
     *
     */
    payment_account_validation_api.prototype.cardvalidation = function(parameters) {
        ...
        var path = '/pav/v1/cardvalidation';
    ...
    return payment_account_validation_api;
})();

exports.payment_account_validation_api = payment_account_validation_api;