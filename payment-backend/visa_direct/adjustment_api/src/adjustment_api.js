...
var adjustment_api = (function() {
    ...
    function adjustment_api(options) {
     ...
     * @method
     * @name adjustment_api#adjustreversefunds
     * @param {string} xClientTransactionId - 
     * @param {} adjustreversefundsPOSTPayload - Resource body for Create Adjustment Reverse Funds Transaction
     *
     */
    adjustment_api.prototype.adjustreversefunds = function(parameters) {
        ...
        var path = '/visadirect/v1/adjustment';
    ...
    return adjustment_api;
})();

exports.adjustment_api = adjustment_api;