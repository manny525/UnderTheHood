...
This is a sample implementation of adjustment_api only for reference purpose.
...
------------- | ------------- | -------------
    *adjustreversefunds* | **POST** &#x2F;visadirect&#x2F;v1&#x2F;adjustment | Create Adjustment Funds Transaction
