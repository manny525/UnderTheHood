...
// path invoked is '/visadirect/reports/v1/transactiondata';
reports_api.reportingApi(getParameters())
...
function getParameters() {
    var parameters = {
        ...
        "fromDate": "{enter appropriate value}",
        "toDate": "{enter appropriate value}",
