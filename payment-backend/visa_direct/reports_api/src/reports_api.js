...
var reports_api = (function() {
     ...
     * Transaction Data
     * @method
     * @name reports_api#reportingApi
     * @param {string} xClientTransactionId - 
     * @param {} fromDate - 
     * @param {} toDate - 
     *
     */
    reports_api.prototype.reportingApi = function(parameters) {
        ...
        var path = '/visadirect/reports/v1/transactiondata';
        ...
        if (parameters['fromDate'] === undefined) {
            deferred.reject(new Error('Missing required  parameter from path parameters: fromDate'));
        ...
        if (parameters['toDate'] === undefined) {
            deferred.reject(new Error('Missing required  parameter from path parameters: toDate'));
            return deferred.promise;
        }
...
exports.reports_api = reports_api;