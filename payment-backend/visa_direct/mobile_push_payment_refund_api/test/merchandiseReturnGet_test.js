...
// path invoked is '/visadirect/mvisa/v1/mr/{statusIdentifier}';
mobile_push_payment_refund_api.merchandiseReturnGet(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is merchandiseReturnGet ---------------');
        console.log('\n\n');
    })
