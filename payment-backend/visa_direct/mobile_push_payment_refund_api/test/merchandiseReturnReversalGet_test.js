...
// path invoked is '/visadirect/mvisa/v1/mrr/{statusIdentifier}';
mobile_push_payment_refund_api.merchandiseReturnReversalGet(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is merchandiseReturnReversalGet ---------------');
        console.log('\n\n');
    })
