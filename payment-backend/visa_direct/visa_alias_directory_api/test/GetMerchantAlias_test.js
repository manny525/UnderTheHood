...
// path invoked is '/visaaliasdirectory/v1/managemerchant';
visa_alias_directory_api.GetMerchantAlias(getParameters())
...
function getParameters() {
    var parameters = {
        ...
        "merchantaliasid": "{enter appropriate value}",
