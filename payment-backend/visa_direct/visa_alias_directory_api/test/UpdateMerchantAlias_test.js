...
// path invoked is '/visaaliasdirectory/v1/managemerchant/updatealias';
visa_alias_directory_api.UpdateMerchantAlias(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is UpdateMerchantAlias ---------------');
        console.log('\n\n');
    })
