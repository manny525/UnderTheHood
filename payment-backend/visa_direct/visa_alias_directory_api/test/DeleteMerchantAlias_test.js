...
// path invoked is '/visaaliasdirectory/v1/managemerchant/deletealias';
visa_alias_directory_api.DeleteMerchantAlias(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is DeleteMerchantAlias ---------------');
        console.log('\n\n');
    })
