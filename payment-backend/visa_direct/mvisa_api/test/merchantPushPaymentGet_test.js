...
// path invoked is '/visadirect/mvisa/v1/merchantpushpayments/{statusIdentifier}';
mvisa_api.merchantPushPaymentGet(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- API is Mvisa Api ---------------');
        console.log('\n--------------- EndPoint is merchantPushPaymentGet ---------------');
        console.log('\n\n');
    })
