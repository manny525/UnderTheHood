...
'use strict';
var api = require('../src/query_api').query_api;
var authCredentials = require('../credentials.json');

var query_api = new api(authCredentials);

// path invoked is '/visadirect/v1/transactionquery';
query_api.transactionQuery(getParameters())
...
function getParameters() {
    var parameters = {
        ...
        "acquiringBIN": "{enter appropriate value}",
