...
// path invoked is '/visaaliasdirectory/v1/managemerchant/createalias';
visa_alias_directory_api.CreateMerchantAlias(getParameters())
    .then(function(result) {
        ...
        console.log('\n--------------- EndPoint is CreateMerchantAlias ---------------');
        console.log('\n\n');
    })
