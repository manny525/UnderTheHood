...
// path invoked is '/visaaliasdirectory/v1/managereport';
visa_alias_directory_api.GetReport(getParameters())
...
function getParameters() {
    var parameters = {
        ...
        "reportid": "{enter appropriate value}",
        "pageid": "{enter appropriate value}",
